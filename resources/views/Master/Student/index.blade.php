                    ...
                    <table class="table table-striped" id="table1">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{ $student->phone ?? '-' }}</td>
                                <td>
                                    <span class="badge bg-{{ $student->is_active == 1 ? 'success' : 'secondary' }}">
                                        {{ $student->is_active == 1 ? 'Siswa' : 'Alumni' }}
                                    </span>
                                </td>
                                <td>
                            ...
                            @include('Master.Student.edit')
                            @include('Master.Student.delete')
                            @endforeach
                        </tbody>
                    </table>
                </div>
